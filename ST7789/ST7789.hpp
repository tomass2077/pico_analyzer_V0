...
private:
    ...
    uint8_t *image_;         // Image buffer
    uint16_t *line_buffer_a; // Buffer for one line of image data
    uint16_t *line_buffer_b; // Buffer for one line of image data
